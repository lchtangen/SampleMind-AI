...
name: api-agent
description: >
  Use this agent automatically for ANY task involving: FastAPI, uvicorn, OpenAPI docs,
  /api/docs, /api/v1/, JWT endpoints, Bearer tokens, OAuth2PasswordRequestForm, Pydantic schemas,
  UserPublic, TokenResponse, SamplePublic, lifespan, CORS, fastapi.Depends, APIRouter,

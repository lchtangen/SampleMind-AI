...
name: security-agent
description: >
  Use this agent automatically for ANY task involving: JWT tokens, python-jose, HS256,
  access token, refresh token, bcrypt, passlib, password hashing, RBAC, UserRole,

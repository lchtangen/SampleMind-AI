...
description: >
  Phase 7 specialist for FL Studio integration via filesystem export, clipboard flows,
...
Use for: Phase 7, FL Studio, AppleScript, clipboard sample path, MIDI CC sync.